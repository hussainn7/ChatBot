...
PICOVOICE_TOKEN = "4P1a/VXpX+/QGhn4OoxFWK/hSswkJV9u6+YYKQqdlF+NZOT5GmArbA=="
...
print(f"PICOVOICE_TOKEN: {os.getenv('PICOVOICE_TOKEN')}")

if not PICOVOICE_TOKEN:
    print("Error: PICOVOICE_TOKEN is empty. Please provide a valid access key.")
    exit(1)
...
print(f"Hussain начал свою работу ...")
play("run")
time.sleep(0.5)
